...
| `11000-11999` | Local business debug endpoints. |
...
| MinIO API and console | Prod-like | `9000`, `9001` | Internal artifact backend; host UI kept dev-only. |
...
[`local-prod-runtime.md`](local-prod-runtime.md). In the production-like runtime,
MinIO can be referenced by optional `s3://` object URIs inside promoted manifests
without publishing MinIO API or console ports to the host.
